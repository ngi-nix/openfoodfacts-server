{
  ...
  outputs = { self, nixpkgs, unstable, openfoodfacts-server-src }:
    let
      ...
      perlDeps = { lib, fetchurl, buildPerlPackage, perlPackages }:
        with perlPackages; rec {
          XMLEncoding = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/S/SH/SHAY/XML-Encoding-2.11.tar.gz";
              sha256 =
          ...
          GraphicsColor = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/G/GP/GPHAT/Graphics-Color-0.31.tar.gz";
              sha256 =
          ...
          BarcodeZBar = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/S/SP/SPADIX/Barcode-ZBar-0.04.tar.gz";
              sha256 =
          ...
          experimental = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/L/LE/LEONT/experimental-0.025.tar.gz";
              sha256 =
          ...
          MongoDB = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/M/MO/MONGODB/MongoDB-v2.2.2.tar.gz";
              sha256 =
          ...
          CLDRNumber = buildPerlModule {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/P/PA/PATCH/CLDR-Number-0.19.tar.gz";
              sha256 =
                "c6716488e65fe779ff79a83f0f2036ad94463efe3d0f349c6b99112975bd85fc";
            };
            buildInputs =
              [ SoftwareLicense TestDifferences TestException TestWarn ];
            propagatedBuildInputs =
          ...
          SpreadsheetCSV = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/D/DD/DDICK/Spreadsheet-CSV-0.20.tar.gz";
              sha256 =
          ...
          DevelSize = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/N/NW/NWCLARK/Devel-Size-0.83.tar.gz";
              sha256 =
          ...
          ActionRetry = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/D/DA/DAMS/Action-Retry-0.24.tar.gz";
              sha256 =
          ...
          MathFibonacci = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/V/VI/VIPUL/Math-Fibonacci-1.5.tar.gz";
              sha256 =
          ...
          ModuleBuildPluggableCPANfile = buildPerlModule {
            ...
            meta = {
              homepage =
                "https://github.com/kazeburo/Module-Build-Pluggable-CPANfile";
          ...
          ColorLibrary = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/R/RO/ROKR/Color-Library-0.021.tar.gz";
              sha256 =
          ...
          MooseXStorage = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/E/ET/ETHER/MooseX-Storage-0.53.tar.gz";
              sha256 =
          ...
          TestDeepType = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/E/ET/ETHER/Test-Deep-Type-0.008.tar.gz";
              sha256 =
          ...
          LEOCHARRECLI = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/L/LE/LEOCHARRE/LEOCHARRE-CLI-1.19.tar.gz";
              sha256 =
          ...
          Linuxusermod = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/V/VI/VIDUL/Linux-usermod-0.69.tar.gz";
              sha256 =
          ...
          UUIDURandom = buildPerlPackage {
            ...
            src = fetchurl {
              url =
                "mirror://cpan/authors/id/D/DA/DAGOLDEN/UUID-URandom-0.001.tar.gz";
              sha256 =
          ...
          LogAnyAdapterTAP = buildPerlPackage {
            ...
            meta = {
              homepage =
                "https://github.com/silverdirk/perl-Log-Any-Adapter-TAP";
      ...
      server-backend = { lib, stdenv, perl, perlPackages, apacheHttpd
        ...
        stdenv.mkDerivation rec {
          ...
          perlDeps =
            with perlPackages; with extraPerlDeps; [
            CGI
            TieIxHash
            LWPUserAgent
    ...
    in {
      ...
      overlays.extraPerlDeps = final: prev: {
        extraPerlDeps = final.callPackage perlDeps { };
      };
