{ openfoodfacts-server-src, lib, stdenv, perl, perlPackages, apacheHttpd
, apacheHttpdPackages, imagemagick, graphviz, tesseract, gnumeric, extraPerlDeps
}:

stdenv.mkDerivation rec {
  name = "openfoodfacts-server-src-0.0.1";
